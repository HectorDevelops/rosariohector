...
const About = ({ isDark }) => {
  return (
    ...
    >
      <div className="max-w-screen-lg p-1 mx-auto w-full shadow-lg rounded-3xl bg-slate-100 dark:bg-neutral-800 dark:border border-gray-600 ">
        <div className="">
          <div className="flex flex-wrap h-80 mt-6 place-content-center  text-black dark:text-white">
            <div className="pr-2">
